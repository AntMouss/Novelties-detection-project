...
from novelties_detection.Experience.kwargsGen import CalculatorKwargs , KwargsResults , UpdateBadWordsKwargs
...
micro_calculator_type = Sequential_Module.LDASequentialSimilarityCalculator
macro_training_args = {"passes" : 2 , "overrate" : 1000}
...
macro_calculator_kwargs = CalculatorKwargs(
    calculator_type=macro_calculator_type,
    nb_topics=5 ,
    bad_words_args=bad_words_kwargs ,
    seed=seed ,
    labels_idx=labels_idx ,
    training_args=macro_training_args
)

micro_calculator_kwargs = CalculatorKwargs(
